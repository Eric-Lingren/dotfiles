...
description: >
  ...
  verdict. Slots into the mandatory diligence gate inside pr-revise when built.
model: sonnet
effort: high
---
...
It serves as a wiring anchor in `skill-pipeline.json` for the pr-revise diligence gate.
