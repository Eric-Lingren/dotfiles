---
name: to-prd-md
description: Turn the current conversation context into a PRD and save it to docs/prd/. Use when user wants to create a PRD from the current context in a markdown format.
---
