...
(`subagent_type: capture-learning`) with: `skill` (this skill's slug: `prototype`),
...
**What's next:**
<!-- skill-done: prototype -->
  - `/to-seed` — prototype confirmed the approach and ready to capture decisions
